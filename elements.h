...
public:
	...
	float inline cross(const mat21 & other) { return this->buffer[0] * other.buffer[1] - this->buffer[1] * other.buffer[0]; }
};
...
public:
	...
	mat31 inline cross(const mat31 & other) { return mat31(buffer[1] * other.buffer[2] - buffer[2] * other.buffer[1], buffer[2] * other.buffer[0] - buffer[0] * other.buffer[2], buffer[0] * other.buffer[1] - buffer[1] * other.buffer[0]); }
};
